...
import co.igloohome.igloohome_sdk_demo.server.EKeyRequest
import co.igloohome.igloohome_sdk_demo.server.PairingDataRequest
import co.igloohome.igloohome_sdk_demo.server.ServerApi
import co.igloohome.igloohome_sdk_demo.server.getDaylightSavings
                ...
                commandDisposables.add(
                    ...
                    connectionMgr.getConnectedLock(lock)
                        .flatMapCompletable{ lockConnected ->
                            lockConnected.unlock( (System.currentTimeMillis() / 1000).toInt() )
                        }
                        .observeOn(AndroidSchedulers.mainThread())
                        .subscribe({
                ...
                commandDisposables.add(
                    getUserInput(listOf("PIN (String)", "PIN Type", "Start Time?", "End Time?"))
                        .flatMapCompletable {
                            ...
                            val startTime = it[2].toIntOrNull()
                            val endTime = it[3].toIntOrNull()
                            //You might want to call getConnectedLock() first here. See unlock() command above.
                ...
                commandDisposables.add(
                    getUserInput(
                        ...
                        .flatMapCompletable {
                            ...
                            val startTime = it[3].toIntOrNull()
                            val endTime = it[4].toIntOrNull()
                            //You might want to call getConnectedLock() first here. See unlock() command above.
            ...
            pairedCommands[13] -> { //Set Time
                ...
                commandDisposables.add(
                    getDateFromUser()
                        ...
                        .flatMap { calendar ->
                            val epochTime = (calendar.timeInMillis / 1000).toInt()
